...
#### ❝ 쇼핑몰의 필수 기능(상품조회, 회원가입, 장바구니, 주문 및 결제 등)을 구현한 웹 서비스입니다 ❞
...
로그인한 사용자만 접근 가능하며, 서버에 GET 요청을 보내 사용자 정보를 조회합니다. <br/>
정보 수정을 원할시에는 수정 버튼을 클릭하여 주소, 연락처 등 일부 정보를 수정할 수 있습니다.
